% LW for hormonic potential

function [k,MM] = levy_walk_HP(x0, v0, w, t, alpha)

clearvars -except t alpha x0 v0 F0 w
...
while 1 == 1
    ...
    if dt <= t
        ...
        r2 = rand;
        if r2 <= 0.5
            xx = x * cos(w * tau2) + v0/w * sin(w * tau2);
        else
            xx = x * cos(w * tau2) - v0/w * sin(w * tau2);
        end
        l = xx - x;
